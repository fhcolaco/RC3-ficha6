...
- **Wi‑Fi**: AP Wi‑Fi6 PoE+ com controlador na cloud ou virtual no stack L3. SSID corporativo e convidado com VLANs separadas.
- **Videovigilância**: câmaras PoE 1080p H.264 ligadas às portas de acesso; gravação no serviço cloud (conforme T+G=5).

## Identificação dos distribuidores
...
## Esquema de bastidor (exemplo ZT1)
...
## Traçado de cabos e tomadas (Armazém)
...
## Serviço adicional para grupos pares – Partilha de Ficheiros
...
## Orçamento resumido (valores indicativos)
